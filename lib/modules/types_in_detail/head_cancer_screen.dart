      ...
      DetailsModel(
        ...
        regimens: <RegimenModel>[
          ...
          RegimenModel(
            ...
            regimenDetails:
                "Days 1-4: 5-FU ${(600/area).toStringAsPrecision(3)} mg/day as continuous IV infusion for 4 days + "
                "carboplatin ${(70/area).toStringAsPrecision(3)}/day IV bolus. \nRepeat every 3 weeks for 3 cycles.",
          ),
          RegimenModel(
            regimenName: "* 5-FU + hydroxyurea",
            regimenDetails:
                "Day 1: Hydroxyurea 1,000mg orally every 12 hours (11 doses/cycle) +"
                " 5-FU ${(800/area).toStringAsPrecision(3)}/day continuous IV infusion",
          ),
          RegimenModel(
            regimenName: "* Cisplatin + paclitaxel",
            regimenDetails:
                "Day 1: Paclitaxel${(30/area).toStringAsPrecision(3)} mg IV (every Monday), plus "
                "\nDay 2: Cisplatin ${(20/area).toStringAsPrecision(3)} mg IV (every Tuesday).",
          ),
          RegimenModel(
            regimenName: "* Cisplatin + infusional 5-FU",
            regimenDetails:
                "Day 1: Cisplatin ${(60/area).toStringAsPrecision(3)} mg over 15 minutes, plus "
                "\n Days 1-5: 5-FU ${(800/area).toStringAsPrecision(3)} mg/day by continuous infusion for 5 days",
          ),
          RegimenModel(
          ...
          RegimenModel(
            ...
            regimenDetails:
                "Day 1-28: Cisplatin ${(40/area).toStringAsPrecision(3)} IV over 30 minutes weekly "
                "\nOR\nDay 1-28: Cisplatin ${(40/area).toStringAsPrecision(3)} IV weekly.",
          ),
        ],
      ),
      DetailsModel(
        ...
        regimens: <RegimenModel>[
          RegimenModel(
            ...
            regimenDetails: "Day 1, 22, and 43: cisplatin ${(100/area).toStringAsPrecision(3)} mg IV",
          ),
        ],
      ),
      DetailsModel(
        ...
        regimens: <RegimenModel>[
          RegimenModel(
            ...
            regimenDetails:
                "Day 1: Docetaxel ${(75/area).toStringAsPrecision(3)} mg IV + cisplatin ${(75/area).toStringAsPrecision(3)} mg IV, plus "
                "\nDays 1-5 : 5-FU ${(750/area).toStringAsPrecision(3)} mg/day continuous IV.",
          ),
          RegimenModel(
            regimenName: "* Paclitaxel + cisplatin + infusional 5FU27d",
            regimenDetails: "Day 1: Paclitaxel ${(175/area).toStringAsPrecision(3)} mg over 3 hours, "
                "\nDay 2: Cisplatin ${(100/area).toStringAsPrecision(3)} mg, plus "
                "\nDay 2-6 : 5-FU ${(500/area).toStringAsPrecision(3)} mg/day continuous IV infusion for 5 days."
                "\nRepeat every 3 weeks for 3 cycles.",
          ),
        ],
      ),
